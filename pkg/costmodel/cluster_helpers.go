...
func buildCPUCoresMap(
	...
	clusterAndNameToType map[nodeIdentifierNoProviderID]string,
) (m map[nodeIdentifierNoProviderID]float64) {
...
func buildRAMBytesMap(resNodeRAMBytes []*prom.QueryResult) (m map[nodeIdentifierNoProviderID]float64) {
...
func buildCPUBreakdownMap(resNodeCPUModeTotal []*prom.QueryResult) (cpuBreakdownMap map[nodeIdentifierNoProviderID]*ClusterCostsBreakdown) {
	// Mapping of cluster/node=cpu for computing resource efficiency
...
func buildRAMUserPctMap(resNodeRAMUserPct []*prom.QueryResult) (m map[nodeIdentifierNoProviderID]float64) {
...
func buildRAMSystemPctMap(resNodeRAMSystemPct []*prom.QueryResult) (m map[nodeIdentifierNoProviderID]float64) {
...
func buildActiveDataMap(resActiveMins []*prom.QueryResult, resolution time.Duration, providerIDParser func(string) string) (m map[NodeIdentifier]activeData) {
